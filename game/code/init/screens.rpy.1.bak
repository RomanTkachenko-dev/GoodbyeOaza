...
screen countdown:
    ...
    bar value AnimatedValue(0, time, time, time)xalign 0.5 yalign 0.9 xmaximum 300 # Это  вертикальная черта таймера.
...
screen navigation():
    ...
    vbox:
        ...
        if renpy.get_screen("main_menu"):
            textbutton _("{space=30}Завантажити") action ShowMenu("load")
        else:
            textbutton _("Завантажити") action ShowMenu("load")


        if renpy.get_screen("main_menu"):
            textbutton _("{space=60}Налаштування") action ShowMenu("preferences")
        else:
        ...
        if renpy.get_screen("main_menu"):
            textbutton _("{space=90}Про гру") action ShowMenu("about")
        else:
        ...
        if renpy.variant("pc") or (renpy.variant("web") and not renpy.variant("mobile")):
            ...
            if renpy.get_screen("main_menu"):
                textbutton _("{space=120}Довідка") action ShowMenu("help")
            else:
        ...
        if renpy.variant("pc"):
            ...
            if renpy.get_screen("main_menu"):
                textbutton _("{space=160}Вийти") action Quit(confirm=not main_menu)
            else:
