label scene_three:
    ...
    play music "audio/Пісні Павка/ПісняА2.mp3"
        ...
        "Просто чекати на відповідь":
            ...
            menu:
                ...
                "Пфф. Спроба вразити detected":
                    ...
                    павка "Я і так це знаю! Ти ж не думаєш, що я така сама наївна, як інші мешканці Купола?"
                    ...
                    show павка рішуча at left2
                    павка "Так що я маю зробити, щоб ти допоміг мені вибратися з Купола?"
    ...
    menu:
        ...
        "Пфф. Спроба вразити detected":
            ...
            павка "Я і так це знаю! Думаєш я така ж наївна, як і інші мешканці Купола?"
