label scene_four:
    ...
    інкі "А потім я дізнаюся з новин, що ще одна дурепа сіганула з багатоповерхівки"
    ...
    show павка рішуча at left2
    павка "Ти ніколи не думала, що ця синтетика нам насправді непотрібна?"

    show інкі скептична at right2
    інкі "Чому ти питаєш?"

    show павка сумна at left2
    павка "Знаєш, були часи, коли люди не жили на синтетиці"

    show інкі задумлива at right2
    інкі "Я тобі більше скажу — я навіть намагалася кинути приймати годіум, як всі в підлітковому віці. І це закінчилося ДУЖЕ погано"
    ...
    show інкі збуджена at right2
    інкі "Ой, дивись, там нова реклама!"
