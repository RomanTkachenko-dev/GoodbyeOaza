label scene_five:
    ...
    інкі "О! Поліція тут вже побувала"
    show інкі здивована at right2

    інкі "Ти була права — його й справді обікрали"
    show інкі задумлива at right2

    інкі "Може в тебе дар передбачення?"

    show павка весела at left2
    павка "Не кажи дурниць, Інкі. Краще допоможи мені краще зняти ці стрічки"
    ...
    інкі "І як копи могли упустити це? Це просто не вкладається в голові"

    show інкі весела at right2
    show павка налякана at left2
    інкі "Треба викликати поліцію"

    павка "Тількі не це!!"

    show інкі скептична at right2
    show павка розгублена at left2
    інкі "А-га! Злякалася, що всі дізнаються, що ти сьогодні Невживанка?"
    ...
    menu:
        "Нав'яжуть бюрократію":
            show інкі скептична at right2
            show павка весела at left2
            павка "Просто не хочу гаяти свій час на посиденьки над їхньою бюрократією. Ну ти знаєш — в них купа документації. Ми тупо потратимо на то обідню перерву"
        "Де копи — там нещасні випадки":
            show інкі скептична at right2
            show павка рішуча at left2
            павка "Не хочу залучати сюди поліцію. Де копи — там завжди хто-небудь помирає або травмується"
    ...
    інкі "Бо це ж ми в секторі А-91О, тут злочиність зашкалює"
    ...
    інкі "Передай мені голографічну карту під номером 91ОЩ. Я постараюся тут швиденько закінчити"
    ...
    "Так, коли мова йде про встановлення софта на трансконектор, Інкі не має рівних"

    "Технік другої ступіні у ї 21 — це вам не хухри мухри"

    show павка нейтральна at left2
    інкі "А знаєш, Павко, я вчора читала в новинах, що сектор А104-Р перший в антирейтингу по самогубствах"

    show павка сумна at left2
    павка "М-хм. Ми ж тамішній трансконектор минулого тижня три рази ремонтували!"

    інкі "Отожбо… І то тільки в нашу зміну. Там не просто хакери — там в людей агресія зашкалює. Крушать все що бачать"
    ...
    show робі злий at center
    робі "Я заслужив свій базовий годіум! І я нікуди не піду з цього місця доки його не отримаю!"
                ...
                "Дати Робі годіум Інкі":
                    ...
                    menu:
                        ...
                        "Відрізати" :
                            ...
                            show павка нейтральна at left2
                            інкі "Я такого від тебе не очикувала, кицюне"
