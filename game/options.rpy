...
define gui.about = _p("""
Життя механиці Павки не надто оригінальне. Літаєш собі по місту, ремонтуєш трансконектори, спілкуєшся з подругою, що сидить на годіумі... Хоча хто в місті під куполом не вживає годіум? Адже це єдиний спосіб пережити радість.

Павка знайшла свій спосіб жити без годіуму. Цей спосіб — музика. І одного разу Павка наважується на втечу з міста...
""")
...
define build.name = "Goodbye_Oaza"
