...
define config.name = _("Прощавай, Оазо")
...
define gui.about = _p("""
Життя механиці Павки не надто оригінальне. Літаєш собі по місту, ремонтуєш трансконектори, спілкуєшся з подругою, що сидить на годіумі.
В місті Купол годіум вживають усі: це єдиний спосіб пережити радість в світі, де заборонене мистецтво.
Але Павка знає спосіб жити без годіуму. Цей спосіб — музика. І одного разу заради музики Павка наважується на втечу.
...
define build.name = "Goodbye Oaza"
...
define config.main_menu_music = "audio/ТемаМіста.mp3"
...
define config.save_directory = "GoodbyeOaza-1676196598"
